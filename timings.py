...
def test_build_it(starts, ends, values):
    ...
    print("Python based intervaltrees took ", minutes, " and ", seconds, "seconds to build the tree.")
...
def test_build_qs(starts, ends, values):
    ...
    print("Cython based intervaltrees took ", minutes, " and ", seconds, "seconds to build the tree.")
...
def test_build_kt(starts, ends, values):
    ...
    print("C based intervaltrees took ", minutes, " and ", seconds, "seconds to build the tree.")

# test_build_it(list(starts), list(ends), list(values))
# test_build_qs(list(starts), list(ends), list(values))
test_build_kt(list(starts), list(ends), list(values))
